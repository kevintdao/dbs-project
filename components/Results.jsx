        ...
        <tbody className={styles.body}>
            {data.map((item, i) => (
              <tr key={i}>
                ...
                <td className={styles.cell} id={`love-${i}`}>{item.nlove}</td>
                <td className={styles.cell} id={`like-${i}`}>{item.nlike}</td>
                <td className={styles.cell} id={`dislike-${i}`}>{item.ndislike}</td>
                <td className={styles.cell} id={`score-${i}`}>{item.score}</td>
              </tr>
            ))}
        </tbody>
      </table>
